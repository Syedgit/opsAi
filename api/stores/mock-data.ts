...
// Helper function to get store-specific mock data
function getStoreMockData(storeId: string, type: string): any[] {
  const storeData: Record<string, Record<string, any[]>> = {
    S001: {
      sales: [
        { id: '1', date: new Date('2026-01-14'), data: { cash: 2100, card: 5400, tax: 320, total_inside: 7820 }, confidence: 0.9 },
        { id: '2', date: new Date('2026-01-13'), data: { cash: 1950, card: 5200, tax: 300, total_inside: 7450 }, confidence: 0.9 },
        { id: '3', date: new Date('2026-01-12'), data: { cash: 2200, card: 5800, tax: 350, total_inside: 8350 }, confidence: 0.9 },
        { id: '4', date: new Date('2026-01-11'), data: { cash: 1800, card: 4900, tax: 280, total_inside: 6980 }, confidence: 0.9 },
        { id: '5', date: new Date('2026-01-10'), data: { cash: 2050, card: 5600, tax: 330, total_inside: 7980 }, confidence: 0.9 },
      ],
      invoices: [
...
// Helper function to serialize dates in mock data
function serializeMockData(data: any[]): any[] {
...
export default function handler(req: VercelRequest, res: VercelResponse): void {
  ...
  const serializedData = serializeMockData(mockData);
  res.json({ [type]: serializedData });
}
